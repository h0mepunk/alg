...
# вида y = kx + b, проходящей через эти точки.	# вида y = kx + b, проходящей через эти точки.
...
print('Уравнение прямой в дробном виде: у = (', k_ups, '/', k_downs,
      ')x +', x1 * k_ups, '/', k_downs, '+',  y1 * (y2-y1))
